package com.vamandeshmukh.demo.aop;
...
public class BooksInterceptor {
	...
	//Weaving & Weaver
	 ...
	 @Before("execution(* com.vamandeshmukh.demo.controllers.BookController.*(..))")
	public void beforeBookControllerMethods(JoinPoint joinPoint){
		...
		logger.info("Executing before method Name => " + methodName + " arguments =>" + args);
	 	...
	 	@AfterThrowing(pointcut = "execution(* com.vamandeshmukh.demo.controllers.BookController.*(..))", throwing = "exception")
	 ...
	 @AfterReturning(pointcut = "execution(* com.vamandeshmukh.demo.controllers.BookController.*(..))", returning = "result")	 
