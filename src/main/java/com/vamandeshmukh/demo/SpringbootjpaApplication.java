...
import com.vamandeshmukh.demo.service.UserService;
...
public class SpringbootjpaApplication {
	...
	InitializingBean sendDatabase() {
		return () -> {
			libraryService.addBook(new Book("The Power of your Subconscious Mind", 296, "Joseph Murphy", "self-help",
					2015, 50, "http://localhost:3006/assets/books/SELF-HELP-0001.jpg"));
			libraryService.addBook(new Book("Great Gatsby", 240, "F. Scott Fitzgerald", "literature", 1939, 8,
					"http://localhost:3006/assets/books/LITERATURE-0002.jpg"));
			libraryService.addBook(new Book("The Alchemist", 50, "Paulo Coelho", "novel", 1990, 9,
					"http://localhost:3006/assets/books/NOVEL-0003.jpg"));
			libraryService.addBook(new Book("Data Smart", 624, "Foreman, John", "data-science", 2012, 12,
					"http://localhost:3006/assets/books/DATA-SCIENCE-0005.jpg"));
			libraryService.addBook(new Book("God Created the Integers", 114, "Hawking, Stephen", "mathematics", 2006,
