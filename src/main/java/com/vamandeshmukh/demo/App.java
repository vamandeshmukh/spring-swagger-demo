...
public class App {
	...
	InitializingBean sendDatabase() {
		return () -> {
			bookService.addBook(new Book("The Power of your Subconscious Mind", 296, "Joseph Murphy", "self-help", 2015,
					50, "http://localhost:3006/assets/books/SELF-HELP-0001.jpg"));
			...
			bookService.addBook(new Book("God Created the Integers", 114, "Hawking, Stephen", "mathematics", 2006, 50,
					"http://localhost:3006/assets/books/MATHEMATICS-0006.jpg"));
		};
	}
